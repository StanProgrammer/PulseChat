...
CREATE TABLE "User" (
    ...
    "workspaceName" TEXT NOT NULL DEFAULT 'Default Workspace',
    "avatar" TEXT,
...
-- CreateIndex
CREATE INDEX "User_workspaceName_idx" ON "User"("workspaceName");

-- CreateIndex
CREATE INDEX "User_workspaceName_name_idx" ON "User"("workspaceName", "name");
